    ...
    <div className="default-container page-layout">
      {checkSummedAccount.length > 0 && (
        <div className="Actions-section">
          <PageTitle
            title={t`DarkPool10 V1 Account`}
            subtitle={
              <>
                <Trans>DarkPool10 V1 Arbitrum information for account: {checkSummedAccount}</Trans>
                {getIsSyntheticsSupported(chainId) && (
                  <Trans>
                    <div>
                      <ExternalLink newTab={false} href={`/#/actions/${checkSummedAccount}`}>
                        Check on DarkPool10 V2 {networkName}
                      </ExternalLink>{" "}
                      or{" "}
                      <span
      ...
      <div className="Actions-section">
        <div className="Actions-title">
          {checkSummedAccount ? (
            ...
            <PageTitle
              isTop
              title={t`DarkPool10 V1 Actions`}
              subtitle={
                <>
                  <Trans>DarkPool10 V1 {networkName} actions for all accounts.</Trans>
                  {getIsSyntheticsSupported(chainId) && (
                    <Trans>
                      <div>

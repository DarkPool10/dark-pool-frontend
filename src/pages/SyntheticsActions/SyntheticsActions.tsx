    ...
    <div className="default-container page-layout">
      {checkSummedAccount && (
        <div className="Actions-section">
          <PageTitle
            title={t`DarkPool10 V2 Account`}
            subtitle={
              <>
                <Trans>
                  DarkPool10 V2 {networkName} information for account: {checkSummedAccount}
                </Trans>
                {getIsV1Supported(chainId) && (
                  <Trans>
                    <div>
                      <ExternalLink newTab={false} href={`/#/actions/v1/${checkSummedAccount}`}>
                        Check on DarkPool10 V1 {networkName}
                      </ExternalLink>{" "}
                      or{" "}
      ...
      <div className="Actions-section">
        <div className="Actions-title">
          {checkSummedAccount ? (
            ...
            <PageTitle
              isTop
              title={t`DarkPool10 V2 Actions`}
              subtitle={
                <>
                  <Trans>DarkPool10 V2 {networkName} actions for all accounts.</Trans>

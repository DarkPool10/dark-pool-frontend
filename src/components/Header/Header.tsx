    ...
    <>
      ...
      <header>
          ...
          <div className="App-header large">
            <div className="App-header-container-left">
              <Link className="App-header-link-main" to="/">
                <img src={logoImg} className="big" alt="DarkPool10 Logo" />
                <img src={logoSmallImg} className="small" alt="DarkPool10 Logo" />
              </Link>
              {isHomeSite() ? (
        ...
        {isTradingIncentiveActive && (
          <HeaderPromoBanner>
            <Trans>
              Trade&nbsp;on DarkPool10&nbsp;V2 in&nbsp;Arbitrum and win&nbsp;280,000&nbsp;ARB ({">"} $500k) in prizes in{" "}
              <HeaderLink
                to="/competitions/"
                showRedirectModal={showRedirectModal}
